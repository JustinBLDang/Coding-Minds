...
public static class AudioManager
{
    ...
    // Creates a folder at head of project and saves AudioClip as .wav, returns the file path
    public static string SaveRecording(AudioClip audioClip)
    {
        if (!audioClip)
        {
        ...
        {
            directoryInfo = new DirectoryInfo(Directory.GetCurrentDirectory() + "/" + folderName);
        }
